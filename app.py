...
st.markdown("""
**Purpose:**  
Explore where Big Five animals are spotted in Masai Mara  
...
c2.metric("Animals Selected", len(selected_animals))
...
st.markdown("""
**Note:**  
Sightings are based on GBIF occurrence records and represent  
*observed presence*, not exact population counts.
""")
